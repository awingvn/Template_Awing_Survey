const textFields3 = [
    ...
    { type: 'checkbox', ask: 'Cau hoi 6', answer: 'trả lời 1 \n lctrả lời 2 \n trả lời 3 \n lctrả lời 4' }
];
...
function getAnswer(newArrayAnswer, elementClass) {
    newArrayAnswer = newArrayAnswer.map((x) => {x.valid = false; x.answer = []; return x;})
